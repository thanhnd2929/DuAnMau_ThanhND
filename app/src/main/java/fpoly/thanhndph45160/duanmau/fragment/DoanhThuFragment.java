    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnDoanhThu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Kiểm tra xem ngày đã được nhập hay chưa
                if (tuNgay.isEmpty() || denNgay.isEmpty()) {
                    // Hiển thị thông báo nếu ngày chưa được nhập
                    Toast.makeText(getActivity(), "Vui lòng nhập đầy đủ ngày", Toast.LENGTH_SHORT).show();
                } else {
                    // Ngày đã được nhập, thực hiện tính doanh thu
